...
#    print(f"number of feature : {X_train.shape[1]}  ->  {data['feature_names']}")
    ...
    if accuracy > baseline:
        print("\n[summary] KNN beats the baseline guess")
        print("          -> the features do carry useful signal for Diet_Type")
    else:
        print("\n[summary] KNN does NOT beat the baseline guess")
        print("          because: the features may not be correlated with Diet_Type,")
        print("                   or the dataset/split is too small or noisy")
        print("          note: this is not necessarily a code error —")
        print("                spotting 'no signal in the data' is an important skill")
        print("                for a Data Scientist")
